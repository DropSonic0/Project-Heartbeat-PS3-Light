...
public:
    ...
    // Getters and Setters
    void set_score(int64_t p_val) { score = p_val; set("score", p_val); }
    int64_t get_score() const { return get("score"); }
    void set_hold_bonus(int64_t p_val) { hold_bonus = p_val; set("hold_bonus", p_val); }
    int64_t get_hold_bonus() const { return get("hold_bonus"); }
    void set_slide_bonus(int64_t p_val) { slide_bonus = p_val; set("slide_bonus", p_val); }
    int64_t get_slide_bonus() const { return get("slide_bonus"); }
    void set_rush_bonus(int64_t p_val) { rush_bonus = p_val; set("rush_bonus", p_val); }
    int64_t get_rush_bonus() const { return get("rush_bonus"); }
    void set_max_score(int64_t p_val) { max_score = p_val; set("max_score", p_val); }
    int64_t get_max_score() const { return get("max_score"); }
    void set_failed(bool p_val) { failed = p_val; set("failed", p_val); }
    bool get_failed() const { return get("failed"); }
